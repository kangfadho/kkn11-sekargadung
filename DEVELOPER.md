...
## kkn11-sekargadung/
public/ — Folder aset statis publik

anggota/ — Folder penyimpanan aset foto tim KKN

src/ — Folder kode sumber utama

components/ — Komponen UI independen

Navbar.jsx — Navigasi utama & logika mobile menu

Hero.jsx — Header & banner landing page

ProfilDesa.jsx — Seksi informasi profil desa
...
index.css — Entry styling & impor Tailwind CSS
...
DEVELOPER.md — Catatan teknis & alur pengembangan
